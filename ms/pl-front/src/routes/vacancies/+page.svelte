	...
	const vacancies = [
		{
			...
			description:
				'Занимаемся профессиональной укладкой керамической плитки в жилых и коммерческих объектах. Ищем профессионала с безупречным качеством работы.',
			duties: [
				'Укладка настенной и напольной керамической плитки, керамогранита и мозаики',
